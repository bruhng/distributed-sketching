...
type SketcherClient interface {
	...
	PlotKll(ctx context.Context, in *OrderedValue, opts ...grpc.CallOption) (*PlotKllReply, error)
...
func (c *sketcherClient) PlotKll(ctx context.Context, in *OrderedValue, opts ...grpc.CallOption) (*PlotKllReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *sketcherClient) QueryCount(ctx context.Context, in *AnyValue, opts ...grpc.CallOption) (*CountQueryReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type SketcherServer interface {
	...
	PlotKll(context.Context, *OrderedValue) (*PlotKllReply, error)
...
func (UnimplementedSketcherServer) PlotKll(context.Context, *OrderedValue) (*PlotKllReply, error) {
...
func (UnimplementedSketcherServer) QueryCount(context.Context, *AnyValue) (*CountQueryReply, error) {
...
func _Sketcher_PlotKll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SketcherServer).PlotKll(ctx, req.(*OrderedValue))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Sketcher_QueryCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SketcherServer).QueryCount(ctx, req.(*AnyValue))
	}
	return interceptor(ctx, in, info, handler)
}
